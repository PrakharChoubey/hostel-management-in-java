...
public class AllStudentsLiving extends javax.swing.JFrame {
    ...
    public AllStudentsLiving() {
        ...
        try {
            ...
            while (rs.next()){                
                dtm.addRow(new Object[]{rs.getString(2),rs.getString(1),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8),rs.getString(9)});
                }
